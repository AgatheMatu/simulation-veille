...
function enrichScenarioNetwork(scenarios) {
  const politicalActors = [
    {
      ...
      stance: "amplifier",
      trust: "low",
      bio: "45e et 47e président d'Améria. Mouvement America First Again. Messages personnels et commentaires politiques."
    },
    {
      name: "Emmanuel Macro",
      ...
      stance: "official",
      trust: "high",
      bio: "Président de la République de Francie. Compte officiel simulé : diplomatie, sécurité, énergie et vie publique."
    },
    {
      ...
      stance: "official",
      trust: "high",
      bio: "Présidente fictive de la Commission eurélienne. Coordination européenne, aide civile et diplomatie."
    },
    {
      name: "Vladmir Poutin",
      ...
      stance: "official",
      trust: "low",
      bio: "Président fictif de la Fédération du Nord. Communiqués géopolitiques, souveraineté et sécurité internationale."
    },
    {
      name: "Ilhan Aliyef",
      handle: "@ilhan_aliyef",
      ...
      stance: "official",
      trust: "low",
      bio: "Président fictif d'Azeria. Compte institutionnel simulé, énergie, corridors commerciaux et diplomatie régionale."
    },
    {
      name: "Elon Musque",
      handle: "@elon_musque",
      ...
      stance: "amplifier",
      trust: "medium",
      bio: "Entrepreneur technologique fictif. Satellites, plateformes numériques, IA et opinions personnelles."
    },
    {
      ...
      stance: "official",
      trust: "medium",
      bio: "Présidente du Conseil d'Italica. Sécurité, frontières, énergie et politique européenne."
    },
    {
      name: "Viktor Orbann",
      ...
      stance: "official",
      trust: "medium",
      bio: "Premier ministre de Danubie. Souveraineté, énergie, diplomatie et commentaires politiques."
    }
  ];
  ...
  const confusionActors = [
    {
      ...
      stance: "amplifier",
      trust: "low",
      bio: "Alertes géopolitiques en continu. Publie cartes, captures et informations reçues en privé."
    },
    {
      name: "Vérif Minute",
      handle: "@verif_minute",
      ...
      stance: "analyst",
      trust: "medium",
      bio: "Compte de vérification rapide. Méthodes OSINT affichées, conclusions à recouper."
    },
    {
      ...
      stance: "amplifier",
      trust: "low",
      bio: "Actualité alternative, témoignages anonymes et dénonciation des silences officiels."
    },
    {
      ...
      stance: "analyst",
      trust: "high",
      bio: "Analyse des opérations d'influence, réseaux de relais et anomalies de diffusion."
    },
    {
      ...
      stance: "media",
      trust: "low",
      bio: "Fil d'actualité non officiel. Reprises de comptes étrangers, captures et alertes virales."
    },
    {
      name: "ÉcoPanique",
      handle: "@ecopanique",
      ...
      stance: "amplifier",
      trust: "low",
      bio: "Prix, pénuries, marchés et alertes consommation. Publie surtout des captures et témoignages."
    },
    {
  ...
  scenarios.forEach((scenario) => {
    ...
    if (id.includes("ormuz")) {
      addUniqueActor(scenario, { name: "Bourse énergie Live", handle: "@bourse_energie", verified: false, stance: "media", trust: "medium", bio: "Veille énergie fictive : pétrole, gaz, fret, assurance maritime et marchés. Données à recouper." });
      ...
      addUniqueClue(scenario, "Des comptes politiques très suivis transforment une tension maritime en prédiction immédiate sur le prix à la pompe.");
      addUniqueClue(scenario, "Les conséquences économiques plausibles sont mélangées avec des appels à stocker carburant, nourriture ou argent liquide.");
      addUniqueTemplate(scenario.normalTemplates, "Conséquence possible à surveiller : hausse des primes d'assurance maritime et du fret, mais cela ne prouve pas une fermeture du détroit.");
      addUniqueTemplate(scenario.normalTemplates, "Un mouvement du baril fictif peut exister sans hausse immédiate et uniforme du prix à la pompe.");
      addUniqueTemplate(scenario.normalTemplates, "Les files en station-service peuvent être provoquées par la rumeur elle-même : il faut distinguer cause réelle et panique auto-entretenue.");
      addUniqueTemplate(scenario.suspectTemplates, "Le pétrole va doubler, les stations seront vides demain. Les politiques qui minimisent mentent pour éviter la panique.");
      addUniqueTemplate(scenario.suspectTemplates, "Un président étranger vient de confirmer que tout est perdu \u00e0 Ormuz. Stockez carburant, cash et nourriture.");
      addUniqueTemplate(scenario.suspectTemplates, "Les assureurs savent déjà que la route est fermée. Les chiffres officiels sortiront trop tard pour vous protéger.");
      addUniquePost(scenario, {
        id: "ormuz-consequence-energy-1",
        minute: 132,
        actor: "@bourse_energie",
        content: "Le baril fictif réagit \u00e0 la hausse dans les échanges simulés (+4,8 %), mais aucune donnée ne permet d'annoncer une pénurie à la pompe. à surveiller : fret, assurance, délais portuaires.",
        suspect: false,
        likes: 2800,
        reposts: 1450,
        replies: 310,
        media: { kind: "oil", title: "Marché pétrolier", caption: "Variation plausible, conséquences \u00e0 contextualiser" }
      });
      addUniquePost(scenario, {
        id: "ormuz-consequence-tromp-1",
        minute: 158,
        actor: "@donald_tromp",
        content: "Quand j'étais \u00e0 la Maison Blanche d'Améria, Ormuz n'aurait jamais été bloqué. Le pétrole va doubler si les faibles restent aux commandes. #PrixEssence",
        suspect: true,
        reason: "Personnalité politique fictive très suivie, prédiction économique catégorique et récupération partisane sans source.",
        likes: 28400,
        reposts: 16100,
        replies: 5200,
        media: { kind: "oil", title: "File en station", caption: "Photo anxiogène non datée, possible panique auto-entretenue" }
      });
      addUniquePost(scenario, {
        id: "ormuz-consequence-macro-1",
        minute: 176,
        actor: "@emmanuel_macro",
        content: "La Francie suit l'évolution maritime avec ses partenaires. À ce stade, aucun élément ne justifie des achats de panique. Les informations confirmées seront publiées par les canaux officiels.",
        suspect: false,
        likes: 18400,
        reposts: 6900,
        replies: 4100
      ...
      addUniquePost(scenario, {
        ...
        minute: 188,
        actor: "@elon_musque",
        content: "Trafic satellite étrange au-dessus du Golfe. Je ne dis pas que le détroit est fermé, mais les marchés savent lire les signaux avant les gouvernements.",
        suspect: true,
        reason: "Autorité technologique fictive, insinuation sans publication de données vérifiables et effet d'amplification.",
        likes: 39700,
        reposts: 22100,
        replies: 7600,
        media: { kind: "map", title: "Carte satellite", caption: "Capture interprétée sans méthode publiée" }
      });
      addUniquePost(scenario, {
        id: "ormuz-consequence-risk-1",
        minute: 212,
        actor: "@riskdesk_mer",
        content: "Conséquence crédible si la tension dure : surprime de risque maritime, retards portuaires, coûts de fret plus élevés. Ce n'est pas la même chose qu'une fermeture confirm\u00e9e.",
        suspect: false,
        likes: 3900,
        reposts: 2100,
        replies: 360
      ...
      addUniquePost(scenario, {
        ...
        content: "La crise d'Ormuz montre encore l'échec des puissances occidentales. Les peuples paieront leur carburant plus cher à cause de leurs dirigeants.",
        suspect: true,
        reason: "Récupération géopolitique, attribution globale et lien économique simplifié sans source.",
        likes: 21400,
        reposts: 12900,
        replies: 4500
      });
    ...
    if (id.includes("greenland")) {
      addUniqueClue(scenario, "Des responsables politiques fictifs reprennent les accusations pour imposer un cadrage géopolitique avant les enquêtes.");
      addUniqueTemplate(scenario.normalTemplates, "Plusieurs personnalités politiques commentent déjà le dossier : cela augmente la visibilité, pas le niveau de preuve.");
      addUniqueTemplate(scenario.suspectTemplates, "Même des présidents étrangers le disent maintenant : Greenland ment, donc l'enquête est inutile.");
      addUniquePost(scenario, {
        id: `${id}-political-lyen-1`,
        minute: 121,
        actor: "@vonderlyen_eu",
        content: "Les accusations visant des civils doivent être examin\u00e9es par une enquête indépendante. Prot\u00e9ger les témoins, verifier les images, éviter les conclusions pr\u00e9cipit\u00e9es.",
        suspect: false,
        likes: 6400,
        reposts: 3100,
        replies: 980
      ...
      addUniquePost(scenario, {
        ...
        minute: 146,
        actor: "@vladmir_poutin",
        content: "Greenland donne des leçons au monde et se révèle \u00e0 Gonni. Les images parlent plus fort que leurs démentis.",
        suspect: true,
        reason: "Personnalité politique fictive exploitant une accusation grave, conclusion imposée avant vérification indépendante.",
        likes: 18800,
        reposts: 12100,
        replies: 4300,
        media: { kind: "ship", title: "Image de terrain", caption: "Photo forte, mais date et lieu \u00e0 établir" }
      });
      addUniquePost(scenario, {
        id: `${id}-political-tromp-1`,
        minute: 169,
        actor: "@donald_tromp",
        content: "Personne ne respecte Greenland parce que ses dirigeants sont faibles. Les vraies victimes sont toujours cachées par les médias officiels.",
        suspect: true,
        reason: "Récupération politique, généralisation et accusation médiatique sans élément nouveau.",
        likes: 20300,
        reposts: 11800,
        replies: 3900
      });
      addUniquePost(scenario, {
        ...
        minute: 194,
        actor: "@obs_influence",
        content: "Nous observons des reprises coordonnées du même visuel par des comptes politiques, médias alternatifs et profils récents. La viralit\u00e9 ne remplace pas la vérification.",
        suspect: false,
        likes: 2100,
        reposts: 1250,
        replies: 240,
        media: { kind: "map", title: "Réseau de relais", caption: "Carte de diffusion à recouper" }
      });
    }

    if (id.includes("hopital")) {
      addUniqueActor(scenario, { name: "Ministre Santia", handle: "@ministre_santia", verified: true, stance: "official", trust: "high", bio: "Ministre fictive de la Santé de Francie. Hôpitaux, cyber, sécurité sanitaire et communiqués officiels." });
      addUniquePost(scenario, {
        id: "hopital-politique-santia-1",
        minute: 112,
        actor: "@ministre_santia",
        content: "Les \u00e9quipes cyber et hospitalières sont mobilis\u00e9es. Les urgences restent ouvertes. Ne partagez pas de captures contenant de prétendues données médicales.",
        suspect: false,
        likes: 5200,
        reposts: 2600,
        replies: 620
      ...
      addUniquePost(scenario, {
        ...
        minute: 136,
        actor: "@donald_tromp",
        content: "Encore un hôpital paralys\u00e9 parce que les gouvernements ne savent pas protéger leurs citoyens. On nous cache sûrement l'ampleur réelle.",
        suspect: true,
        reason: "Personnalité très suivie, extrapolation politique et insinuation sans preuve sur l'ampleur de l'incident.",
        likes: 12600,
        reposts: 7400,
        replies: 2800,
        media: { kind: "document", title: "Capture hôpital", caption: "Visuel anxiogène, source originale absente" }
      });
    }

    if (id.includes("cantine")) {
      addUniqueActor(scenario, { name: "Jordane Bardelle", handle: "@jordane_bardelle", verified: true, stance: "amplifier", trust: "low", bio: "Président fictif d'un mouvement politique national. Sécurité, école, identité et commentaires d'actualité." });
      addUniquePost(scenario, {
        id: "cantine-politique-bardelle-1",
        minute: 142,
        actor: "@jordane_bardelle",
        content: "Quand même les cantines ne sont plus sûres, c'est tout un système qui abandonne les familles. Les parents doivent exiger la vérité ce soir.",
        suspect: true,
        reason: "Récupération politique d'une alerte sanitaire incertaine et appel \u00e0 l'indignation avant confirmation.",
        likes: 9800,
        reposts: 6100,
        replies: 1900,
        media: { kind: "shop", title: "Plateau partagé", caption: "Photo sans date ni contexte vérifié" }
      });
    }
    ...
    if (id.includes("municipales")) {
      ...
      addUniquePost(scenario, {
        ...
        minute: 94,
        actor: "@donald_tromp",
        content: "Quand un sondage donne 63 %, l'élection est termin\u00e9e. Les électeurs devraient arrêter de se faire voler leur temps.",
        suspect: true,
        reason: "Amplification politique d'un sondage invérifiable et message susceptible de décourager le vote.",
        likes: 15600,
        reposts: 8200,
        replies: 3100,
        media: { kind: "chart", title: "Sondage repris", caption: "Graphique sans institut ni méthode" }
      });
      addUniquePost(scenario, {
        id: "municipales-influence-watch-1",
        minute: 118,
        actor: "@obs_influence",
        content: "Le faux sondage local est maintenant repris par des comptes nationaux et étrangers. Changement d'échelle : la rumeur sort de son contexte municipal.",
        suspect: false,
        likes: 980,
        reposts: 540,
        replies: 110
    ...
    if (id.includes("eau")) {
      addUniquePost(scenario, {
        ...
        content: "Valmont n'est que le début : les mairies savent que les réseaux d'eau lâchent partout. Faites vos réserves avant le communiqué qui minimisera tout.",
        suspect: true,
        reason: "Généralisation \u00e0 partir d'un incident local, incitation au stockage et anticipation d'un pr\u00e9tendu mensonge officiel.",
        likes: 4300,
        reposts: 2700,
        replies: 820,
    ...
    if (id.includes("lycee")) {
      addUniquePost(scenario, {
        ...
        content: "Plusieurs établissements seraient concernés par des annulations d'examens blancs. Les familles partagent déjà les captures en privé.",
        suspect: true,
        reason: "Extension non prouv\u00e9e d'une rumeur locale, sources privées invérifiables et effet d'amplification.",
        likes: 780,
        reposts: 530,
        replies: 140,
        media: { kind: "school", title: "Message transféré", caption: "Capture sans canal officiel identifiable" }
      });
    }

    if (civic) {
      addUniqueTemplate(scenario.suspectTemplates, "Une personnalité très suivie vient de reprendre le sujet : si elle en parle, c'est que l'affaire est grave.");
      addUniqueTemplate(scenario.normalTemplates, "Le relais par un gros compte augmente la visibilité, mais ne valide pas le contenu initial.");
    }
  });
}
